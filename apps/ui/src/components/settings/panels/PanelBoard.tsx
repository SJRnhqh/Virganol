...
export const PanelBoard = () => {
  ...
  const panels: Record<SettingsTab, ReactElement> = {
    general: <GeneralPanel />,
    scispirit: <SpiritPanel />,
    sciscript: <ComingSoonPanel name="Script" />,
    scicomb: <ComingSoonPanel name="Comb" />,
    scicellar: <ComingSoonPanel name="Cellar" />,
  };
