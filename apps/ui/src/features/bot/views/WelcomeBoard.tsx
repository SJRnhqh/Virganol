  ...
  return (
    <div className="mb-10 flex flex-col items-center gap-8 select-none animate-in fade-in zoom-in duration-700">
      ...
      <div className="relative group cursor-default">
        {/* A. 氛围光晕 */}
        <div className="absolute -inset-8 bg-[radial-gradient(circle,var(--color-spirit-welcome-atomsphere)_0%,transparent_70%)] opacity-60 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700" />
