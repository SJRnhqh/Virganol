...
- [x] Branch closeout ready — remaining context / architecture / observability
  follow-ups have been moved into `docs/ROADMAP.md`

## Planned

- No branch-local planned tasks remain.
